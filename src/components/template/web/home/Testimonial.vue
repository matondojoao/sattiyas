<template>
    <section class="cs_gray_bg">
      ...
      <div class="container">
        <h2 class="cs_section_title cs_fs_50 cs_bold mb-0 text-center">O Que Nossos Clientes Dizem</h2>
      </div>
            ...
            <div class="cs_slider_wrapper">
              <div class="slick_slide_in">
                <div class="cs_testimonial cs_style_1 text-center">
                  <blockquote class="cs_testimonial_text cs_fs_21 cs_semibold">
                    Fazer compras na Sattiyas tem sido uma verdadeira delícia! Tive o prazer de ser cliente no último ano, e posso afirmar com confiança que este é o meu destino de compras online preferido. Recomendo muito!
                  </blockquote>
