<template>
    ...
    <div class="container">
      ...
      <ul class="cs_tab_links cs_style_1 cs_mp0">
        <li class="active"><a href="#tab_tshirt" class="cs_fs_16 cs_medium">Camisetas</a></li>
<li><a href="#tab_jeans" class="cs_fs_16 cs_medium">Calças Jeans</a></li>
<li><a href="#tab_cshirt" class="cs_fs_16 cs_medium">Camisa Casual</a></li>
<li><a href="#tab_leggings" class="cs_fs_16 cs_medium">Leggings</a></li>
<li><a href="#tab_skirts" class="cs_fs_16 cs_medium">Saias</a></li>
<li><a href="#tab_shoes" class="cs_fs_16 cs_medium">Sapatos</a></li>
<li><a href="#tab_accessories" class="cs_fs_16 cs_medium">Acessórios</a></li>
    ...
    <div class="container-fluid">
      <div class="cs_tabs">
        <div class="cs_tab active" id="tab_tshirt">
        ...
        <div class="cs_tab" id="tab_cshirt">
          <div class="cs_slider position-relative cs_hover_arrow">
            <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
              data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2"
              data-lg-slides="3" data-add-slides="4">
        ...
        <div class="cs_tab" id="tab_leggings">
          <div class="cs_slider position-relative cs_hover_arrow">
            <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
              data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2"
              data-lg-slides="3" data-add-slides="4">
        ...
        <div class="cs_tab" id="tab_skirts">
          <div class="cs_slider position-relative cs_hover_arrow">
            <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
              data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2"
              data-lg-slides="3" data-add-slides="4">
        ...
        <div class="cs_tab" id="tab_accessories">
          <div class="cs_slider position-relative cs_hover_arrow">
            <div class="cs_slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
              data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2"
              data-lg-slides="3" data-add-slides="4">
              <div class="cs_slider_wrapper">
                ...
                <div class="slick_slide_in">
                  <div class="cs_product cs_style_1">
                    ...
                    <div class="cs_product_info text-center">
                      <h3 class="cs_product_title cs_fs_21 cs_medium">
                        <a href="product_details.html">Pure black cotton women T-shirt</a>
                      </h3>
                      <p class="cs_product_price cs_fs_18 cs_accent_color mb-0 cs_medium">$350.00</p>
                    </div>
                  </div>
